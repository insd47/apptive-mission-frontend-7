  ...
  const dummyProfiles: Profile[] = [
    {
      name: "김지원",
      id: "kimjiwon1",
      image: domain + "/images/profiles/2EdIX-O2lkI.jpg",
      background: domain + "/images/backgrounds/6uCy44FbdqM.jpg",
    ...
    },
    {
      name: "이민석",
      id: "leeminseok0403",
      image: domain + "/images/profiles/MTZTGvDsHFY.jpg",
      background: domain + "/images/backgrounds/aofRqS6TgFo.jpg",
    ...
    },
    {
      name: "박지영",
      id: "parkjiyoung1216",
      image: domain + "/images/profiles/jzz_3jWMzHA.jpg",
    ...
    },
    {
      name: "최동현",
      id: "choidonghyun2004",
      background: domain + "/images/backgrounds/csxmdSCa4C0.jpg",
    ...
    },
    {
      name: "이지수",
      id: "leejisoo32",
      image: domain + "/images/profiles/rDEOVtE7vOs.jpg",
      background: domain + "/images/backgrounds/GBIgvxa0HIE.jpg",
      status: OnlineStatus.AWAY,
      job: Job.UIUX,
    ...
    },
    {
      name: "박정우",
      id: "parkjungwoo88",
      image: domain + "/images/profiles/QEgHL8NN7nM.jpg",
      status: OnlineStatus.DO_NOT_DISTURB,
    ...
    },
    {
      name: "이도윤",
      id: "leedoyoon95",
      image: domain + "/images/profiles/ZHvM3XIOHoE.jpg",
      background: domain + "/images/backgrounds/uDZ3usCoXB4.jpg",
      status: OnlineStatus.ONLINE,
      job: Job.SERVER,
